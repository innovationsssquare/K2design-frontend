      ...
      <div className="bg-[#f1f2f4] flex justify-center items-center w-full">
        <div className="w-full p-4 shadow-sm ml-4 mr-4 my-4 flex gap-4 justify-center    lg:flex-row flex-col bg-white">
          ...
          <div className=" px-5 w-full">
            <h1 className="text-2xl font-bold mb-4">Backlit Flex Print </h1>
            <p className="text-sm text-gray-600 font-bold mb-4">
              High-quality backlit flex print with vibrant colors.
            </p>
            <p className="mb-4">
            ...
            <ul className="list-disc list-inside mb-4">
              <li>Backlit Flex Print - Economy</li>
              <li>Backlit Flex Print - Premium</li>
            </ul>
          ...
          {`We do not accept designs that belong to or represent government or government-affiliated organizations.`}
            ...
            <div className="mb-4">
              ...
              >
                ...
                <SelectContent>
                  <SelectGroup>
                    <SelectItem value="Backlit Flex Print - Economy">
                      Backlit Flex Print - Economy
                    </SelectItem>
                    <SelectItem value="Backlit Flex Print - Premium">
                      Backlit Flex Print - Premium{" "}
                    </SelectItem>
                  </SelectGroup>
                </SelectContent>
              </Select>
