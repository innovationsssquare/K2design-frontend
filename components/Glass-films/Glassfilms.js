...
import { GetGlassfilmscalculation } from "@/lib/ReduxSlice/Glass-films/glassfilmSlice";
...
const Glassfilms = () => {
  ...
  const { Glassfilmprintresult, loading, error } = useSelector(
    (state) => state.Glassfilmprint
  );

  console.log("Glassfilmprintresult", Glassfilmprintresult);
  ...
  useEffect(() => {
    if (formData.width && formData.height) {
      dispatch(GetGlassfilmscalculation(formData));
    }
  }, [formData, dispatch]);

  useEffect(() => {
    if (Glassfilmprintresult?.message === "Configuration not found") {
      setErrorMessage("Selected options are not available");
    } else {
      setErrorMessage("");
    }
  }, [Glassfilmprintresult]);
      ...
      <div className="bg-[#f1f2f4] flex justify-center items-center w-full">
        <div className="w-full p-4 shadow-sm ml-4 mr-4 my-4 flex gap-4 justify-center    lg:flex-row flex-col bg-white">
          ...
          <div className=" px-5 w-full">
            <h1 className="text-2xl font-bold mb-4">Glass Films</h1>
            <p className="text-sm text-gray-600 font-bold mb-4">
              High-quality Glass Film Prints for windows, doors, and decorative
              purposes.{" "}
            </p>
          ...
          {`We do not accept designs that belong to or represent government or government-affiliated organizations.`}
            ...
            <div className="mb-4">
              ...
              >
                ...
                <SelectContent>
                  <SelectGroup>
                    <SelectItem value="Film-Transparent-Gloss">
                      Film Transparent Gloss
                    </SelectItem>
                    <SelectItem value="Film-Transparent-Matt">Film Transparent Matt</SelectItem>
                    <SelectItem value="Film-Transparent-Gloss 3M">Film-Transparent-Gloss 3M</SelectItem>
                    <SelectItem value="Film-Transparent-Matt 3M">Film-Transparent-Matt 3M</SelectItem>
                    <SelectItem value="Frosted Film-White crystal">Frosted Film-White crystal</SelectItem>
                    <SelectItem value="Frosted Film-White 3M">Frosted Film-White 3M</SelectItem>
                    <SelectItem value="Frosted Film-White-LG Hausys">Frosted Film-White-LG Hausys</SelectItem>
                    <SelectItem value="Frosted Film-Semi Transparent LG Hausys">Frosted Film-Semi Transparent LG Hausys</SelectItem>
                    <SelectItem value="Frosted Film-Silver LG Hausys">Frosted Film-Silver LG Hausys</SelectItem>
                    <SelectItem value="Frosted Film-Texture LG Hausys">Frosted Film-Texture LG Hausys</SelectItem>
                    <SelectItem value="Frosted Film-Sparkle LG Hausys">Frosted Film-Sparkle LG Hausys</SelectItem>
                    <SelectItem value="Black Suncontrol film-Garware">Black Suncontrol film-Garware</SelectItem>
                    <SelectItem value="Black Suncontrol film-Anti Scrach-Garware">Black Suncontrol film-Anti Scrach-Garware</SelectItem>
                    <SelectItem value="Decorative film for window & glass door">Decorative film for window & glass door</SelectItem>
                  </SelectGroup>
                </SelectContent>
              </Select>
            </div>
            ...
            <div className="flex justify-between items-center mb-4">
              <div>
                ...
                <Button
                  className="bg-white  "
                  disabled={Glassfilmprintresult == null}
                >
                  {loading ? (
                    <span className="loader4"></span>
                  ) : (
                    <strong className="text-Apptheme text-lg ">
                      ₹{Glassfilmprintresult?.totalPrice || 0}
                    </strong>
                  )}
                </Button>
